...
const SideMenu = () => {
  ...
  function updateStatus(e, menu) {
    e.stopPropagation();
    if (!pathname.includes(menu)) {
      navigate(menu);
    } else {
      setOpenMenuStatus(!openSubMenu);
    }
  }
                  ...
                  >
                    <Link to={`/menu/dinein`} onClick={handleMenuActive}>
                      <div className="flex mt-1 lg:gap-4">
                        ...
                        {/* Name */}
                        <div
                          className={`hidden lg:block text-base ml-1 2xl:text-base ${
                            pathname.includes("/menu/dinein")
                              ? "text-white"
                              : ""
                          }`}
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/dinein`)
                          }
                          className={`lg:mr-3 lg:ml-14 ml-0 mt-1 lg:mt-2 mr-3  cursor-pointer ${
                ...
                <div className="w-full  mb-1">
                  ...
                  >
                    <Link to={`/menu/kds`} onClick={handleKDS}>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) => updateStatus(event, `/menu/kds`)}
                          className={`lg:mr-4 lg:ml-18 ml-0 mt-0.5 mr-3  cursor-pointer ${
                  ...
                  >
                    <Link to={`/menu/take-away`} onClick={handleTakeaway}>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/take-away`)
                          }
                          className={`lg:mr-4 lg:ml-10 ml-0 mt-1 mr-3  cursor-pointer ${
                  ...
                  >
                    <Link to={`/menu/party-order`} onClick={handlePartyorder}>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/party-order`)
                          }
                          className={`lg:mr-4 mt-1 mr-3 lg:ml-8 ml-0 cursor-pointer ${
                  ...
                  >
                    <Link to={`/menu/reports`} onClick={handleReport}>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/reports`)
                          }
                          className={`lg:mr-4 mt-1 mr-3 lg:ml-13 ml-0 cursor-pointer ${
                  ...
                  >
                    <Link to={`/menu/setting`} onClick={handleSetting}>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/setting`)
                          }
                          className={`lg:mr-4 mt-1 mr-3 lg:ml-14 ml-0 cursor-pointer ${
              ...
              <div>
                ...
                <div className="w-full">
                  <div
                    ...
                    className={`flex place-items-start ml-1 lg:gap-8 w-full py-2 gap-2 lg:pl-2 lg:py-2  lg:p-1 ${
                      pathname.includes("/menu/dinein/active")
                        ? "text-white bg-darkyellow  py-1 rounded-md"
                        : ""
                    }`}
                  >
                    <Link
                      to={`/menu/dinein/active`}
                      onClick={handleMenuWActive}
                    >
                      <div className="flex lg:gap-4">
                        {/* Image */}
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/dinein/active`)
                          }
                          className={`lg:mr-3 lg:ml-1 ml-0 mt-1 mr-3  cursor-pointer ${
                            pathname.includes("dinein")
                              ? "rotateAnimation text-white"
                              : ""
                          }`}
                  ...
                  {/* SubMenu */}
                  {pathname.includes("dinein") && openSubMenu ? (
                    <div className="bg-search py-1 sub-menu-sec rounded-lg ml-1 ">
                      {/* Active order data */}
                      <Link
                        to={`/menu/dinein/${"Active Order"
                          .toLowerCase()
                          .replace(" ", "-")}`}
                      >
                        <div
                ...
                <div className="w-full">
                  <div
                    onClick={() => setOpenMenuStatus(true)}
                    className={`flex place-items-start lg:gap-6 w-full py-2  lg:px-0 gap-1 lg:py-2 lg:p-1 ${
                      pathname.includes("/menu/take-away/order")
                        ? "text-white bg-darkyellow  py-1 rounded-md"
                        : ""
                    }`}
                  >
                    <Link
                      to={`/menu/take-away/order`}
                      onClick={() => setOpenMenuStatus(true)}
                    >
                      <div className="flex lg:gap-4 ">
                        <div>
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          onClick={(event) =>
                            updateStatus(event, `/menu/take-away/order`)
                          }
                          className={`lg:mr-4 lg:ml-12 ml-0 mt-1 mr-3  cursor-pointer ${
                            pathname.includes("take-away")
                              ? "rotateAnimation text-white"
                              : ""
                          }`}
                    ...
                    >
                      ...
                      <div>
                        <ArrowDropDownRoundedIcon
                          ...
                          className={`lg:mr-4 mt-1 mr-3 lg:ml-10 ml-0 cursor-pointer ${
                            pathname.includes("party-order")
                              ? "rotateAnimation text-white"
                              : ""
                          }`}
