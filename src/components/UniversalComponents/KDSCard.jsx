...
const KDSCard = (props) => {
    console.log(props.data.item.meta_order[0].menus,"kds");
  return (
    <div>
              ...
              <div className="h-3/6 overflow-y-scroll">
                {props.data.item.meta_order?.map((ele, index) => (
                  ...
                  >
                    ...
                    <div>
                      {props.data.ele?.menus === null ? (
                        ""
                      ) : (
                        <>
                          {props.data.ele?.status === 1 ? (
                            <div>
                              <button
                                onClick={() => {
                                  props.data.handleClick(props.data.ele?.id, ele?.status);
                                }}
