...
const SalesBody = () => {
  ...
  const getDineIn = async (inputs) => {
    ...
    if (inputs.ordertype === "all") {
      ...
      setType(data.data[0].quantity);
      setRevenue(data.data[0].total);
    } else {
      const data = await axios.get(
  ...
  const handleCetegory = (e) => {
    setInputs({ ...inputs, ordertype: e.target.value, date: "" });
  };
  ...
  return (
    <div className="px-9 pt-2 pb-5">
      ...
      <div className="flex flex-col gap-6  lg:flex-row lg:justify-between">
        ...
        <div className="lg:w-3/4 lg:h-14 lg:flex lg:justify-end">
          <div className=" flex  flex-row gap-4">
          <SelectOption data={{handleChange:handleCetegory,value,data:data1,dvalue:"Select Option"}}/>
